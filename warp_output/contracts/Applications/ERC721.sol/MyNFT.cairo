...
namespace MyNFT{
    ...
    alloc_locals;
        ...
        let (__warp_se_4) = warp_eq(__warp_5_interfaceId, 2158778573);
        ...
        if (__warp_se_4 != 0){
            ...
            let (__warp_se_5) = warp_eq(__warp_5_interfaceId, 33540519);
    ...
    alloc_locals;
        ...
        let (__warp_se_18) = warp_eq(__warp_se_17, __warp_15_owner);
        ...
        if (__warp_se_18 != 0){
            ...
            let (__warp_se_19) = WS3_INDEX_felt_to_warp_id(__warp_3_isApprovedForAll, __warp_15_owner);
            
            let (__warp_se_20) = WS0_READ_warp_id(__warp_se_19);
            
            let (__warp_se_21) = get_caller_address();
            
            let (__warp_se_22) = WS2_INDEX_felt_to_felt(__warp_se_20, __warp_se_21);
            
            let (__warp_se_23) = WS1_READ_felt(__warp_se_22);
            
            let __warp_rc_2 = __warp_se_23;
    ...
    alloc_locals;
        ...
        let (__warp_se_31) = warp_eq(__warp_19_spender, __warp_18_owner);
        ...
        if (__warp_se_31 != 0){
            ...
            let (__warp_se_32) = WS3_INDEX_felt_to_warp_id(__warp_3_isApprovedForAll, __warp_18_owner);
            
            let (__warp_se_33) = WS0_READ_warp_id(__warp_se_32);
            
            let (__warp_se_34) = WS2_INDEX_felt_to_felt(__warp_se_33, __warp_19_spender);
            
            let (__warp_se_35) = WS1_READ_felt(__warp_se_34);
            
            let __warp_rc_6 = __warp_se_35;
    ...
    alloc_locals;
        ...
        if (__warp_rc_6 != 0){
            ...
            let (__warp_se_36) = WS0_INDEX_Uint256_to_felt(__warp_2__approvals, __warp_20_id);
            
            let (__warp_se_37) = WS1_READ_felt(__warp_se_36);
            
            let (__warp_se_38) = warp_eq(__warp_19_spender, __warp_se_37);
            
            let __warp_rc_4 = __warp_se_38;
    ...
    alloc_locals;
        ...
        let (__warp_se_39) = WS0_INDEX_Uint256_to_felt(__warp_0__ownerOf, __warp_24_id);
        
        let (__warp_se_40) = WS1_READ_felt(__warp_se_39);
        
        let (__warp_se_41) = warp_eq(__warp_22_from, __warp_se_40);
        
        with_attr error_message("from != owner"){
            assert __warp_se_41 = 1;
        }
        
        let (__warp_se_42) = warp_neq(__warp_23_to, 0);
        ...
        let (__warp_pse_0) = _isApprovedOrOwner_f7e66828(__warp_22_from, __warp_se_43, __warp_24_id);
        ...
        let (__warp_se_44) = WS1_INDEX_felt_to_Uint256(__warp_1__balanceOf, __warp_cs_0);
        
        let (__warp_se_45) = WS2_READ_Uint256(__warp_se_44);
        
        let (__warp_pse_1) = warp_sub256(__warp_se_45, Uint256(low=1, high=0));
        
        let (__warp_se_46) = WS1_INDEX_felt_to_Uint256(__warp_1__balanceOf, __warp_cs_0);
        
        WS_WRITE1(__warp_se_46, __warp_pse_1);
        
        warp_add256(__warp_pse_1, Uint256(low=1, high=0));
        
        let __warp_cs_1 = __warp_23_to;
        
        let (__warp_se_47) = WS1_INDEX_felt_to_Uint256(__warp_1__balanceOf, __warp_cs_1);
        
        let (__warp_se_48) = WS2_READ_Uint256(__warp_se_47);
        
        let (__warp_pse_2) = warp_add256(__warp_se_48, Uint256(low=1, high=0));
        
        let (__warp_se_49) = WS1_INDEX_felt_to_Uint256(__warp_1__balanceOf, __warp_cs_1);
        
        WS_WRITE1(__warp_se_49, __warp_pse_2);
        
        warp_sub256(__warp_pse_2, Uint256(low=1, high=0));
        
        let (__warp_se_50) = WS0_INDEX_Uint256_to_felt(__warp_0__ownerOf, __warp_24_id);
        
        WS_WRITE0(__warp_se_50, __warp_23_to);
        
        let (__warp_se_51) = WS0_INDEX_Uint256_to_felt(__warp_2__approvals, __warp_24_id);
        
        WS_WRITE0(__warp_se_51, 0);
    ...
    func _mint_4e6ec247{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*, warp_memory : DictAccess*, keccak_ptr : felt*}(__warp_31_to : felt, __warp_32_id : Uint256)-> (){
    alloc_locals;


        
        let (__warp_se_52) = warp_neq(__warp_31_to, 0);
        
        with_attr error_message("mint to zero address"){
            assert __warp_se_52 = 1;
        }
        
        let (__warp_se_53) = WS0_INDEX_Uint256_to_felt(__warp_0__ownerOf, __warp_32_id);
        
        let (__warp_se_54) = WS1_READ_felt(__warp_se_53);
        
        let (__warp_se_55) = warp_eq(__warp_se_54, 0);
        
        with_attr error_message("already minted"){
            assert __warp_se_55 = 1;
        }
        
        let __warp_cs_2 = __warp_31_to;
        
        let (__warp_se_56) = WS1_INDEX_felt_to_Uint256(__warp_1__balanceOf, __warp_cs_2);
        
        let (__warp_se_57) = WS2_READ_Uint256(__warp_se_56);
        
        let (__warp_pse_3) = warp_add256(__warp_se_57, Uint256(low=1, high=0));
        
        let (__warp_se_58) = WS1_INDEX_felt_to_Uint256(__warp_1__balanceOf, __warp_cs_2);
        
        WS_WRITE1(__warp_se_58, __warp_pse_3);
        
        warp_sub256(__warp_pse_3, Uint256(low=1, high=0));
        
        let (__warp_se_59) = WS0_INDEX_Uint256_to_felt(__warp_0__ownerOf, __warp_32_id);
        
        WS_WRITE0(__warp_se_59, __warp_31_to);
        
        _emit_Transfer_ddf252ad(0, __warp_31_to, __warp_32_id);
    ...
    func _burn_9b1f9e74{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*, warp_memory : DictAccess*, keccak_ptr : felt*}(__warp_33_id : Uint256)-> (){
    alloc_locals;


        
        let (__warp_se_60) = WS0_INDEX_Uint256_to_felt(__warp_0__ownerOf, __warp_33_id);
        
        let (__warp_34_owner) = WS1_READ_felt(__warp_se_60);
        
        let (__warp_se_61) = warp_neq(__warp_34_owner, 0);
        
        with_attr error_message("not minted"){
            assert __warp_se_61 = 1;
        }
        
        let __warp_cs_3 = __warp_34_owner;
        
        let (__warp_se_62) = WS1_INDEX_felt_to_Uint256(__warp_1__balanceOf, __warp_cs_3);
        
        let (__warp_se_63) = WS1_INDEX_felt_to_Uint256(__warp_1__balanceOf, __warp_cs_3);
        
        let (__warp_se_64) = WS2_READ_Uint256(__warp_se_63);
        
        let (__warp_se_65) = warp_sub256(__warp_se_64, Uint256(low=1, high=0));
        
        WS_WRITE1(__warp_se_62, __warp_se_65);
        
        let (__warp_se_66) = WS0_INDEX_Uint256_to_felt(__warp_0__ownerOf, __warp_33_id);
        
        WS_WRITE0(__warp_se_66, 0);
        
        let (__warp_se_67) = WS0_INDEX_Uint256_to_felt(__warp_2__approvals, __warp_33_id);
        
        WS_WRITE0(__warp_se_67, 0);
        
        _emit_Transfer_ddf252ad(__warp_34_owner, 0, __warp_33_id);
    ...
    @external
    func mint_40c10f19{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_0_to : felt, __warp_1_id : Uint256)-> (){
    alloc_locals;
    ...
    with warp_memory, keccak_ptr{
        ...
        warp_external_input_check_int256(__warp_1_id);
        
        warp_external_input_check_address(__warp_0_to);
        
        MyNFT._mint_4e6ec247(__warp_0_to, __warp_1_id);
    ...
    @external
    func burn_42966c68{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_2_id : Uint256)-> (){
    alloc_locals;
    let (local keccak_ptr_start : felt*) = alloc();
    let keccak_ptr = keccak_ptr_start;
    let (local warp_memory : DictAccess*) = default_dict_new(0);
    ...
    with warp_memory, keccak_ptr{
        ...
        warp_external_input_check_int256(__warp_2_id);
        
        let (__warp_se_0) = get_caller_address();
        
        let (__warp_se_1) = WS0_INDEX_Uint256_to_felt(MyNFT.__warp_0__ownerOf, __warp_2_id);
        
        let (__warp_se_2) = WS1_READ_felt(__warp_se_1);
        
        let (__warp_se_3) = warp_eq(__warp_se_0, __warp_se_2);
        
        with_attr error_message("not owner"){
            assert __warp_se_3 = 1;
        }
        
        MyNFT._burn_9b1f9e74(__warp_2_id);
    ...
    alloc_locals;
        ...
        let __warp_rc_0 = 0;
            ...
            let (__warp_tv_0, __warp_tv_1) = MyNFT.__warp_conditional_supportsInterface_01ffc9a7_1(__warp_5_interfaceId);
    ...
    alloc_locals;
        ...
        let (__warp_se_6) = WS0_INDEX_Uint256_to_felt(MyNFT.__warp_0__ownerOf, __warp_7_id);
        
        let (__warp_se_7) = WS1_READ_felt(__warp_se_6);
        
        let __warp_8_owner = __warp_se_7;
        
        let (__warp_se_8) = warp_neq(__warp_8_owner, 0);
    ...
    alloc_locals;
        ...
        let (__warp_se_9) = warp_neq(__warp_9_owner, 0);
        
        with_attr error_message("owner = zero address"){
            assert __warp_se_9 = 1;
        }
        
        let (__warp_se_10) = WS1_INDEX_felt_to_Uint256(MyNFT.__warp_1__balanceOf, __warp_9_owner);
    ...
    with warp_memory, keccak_ptr{
        ...
        let (__warp_se_13) = WS3_INDEX_felt_to_warp_id(MyNFT.__warp_3_isApprovedForAll, __warp_se_12);
        
        let (__warp_se_14) = WS0_READ_warp_id(__warp_se_13);
        
        let (__warp_se_15) = WS2_INDEX_felt_to_felt(__warp_se_14, __warp_11_operator);
        
        WS_WRITE0(__warp_se_15, __warp_12_approved);
        
        let (__warp_se_16) = get_caller_address();
        
        _emit_ApprovalForAll_17307eab(__warp_se_16, __warp_11_operator, __warp_12_approved);
    ...
    with warp_memory, keccak_ptr{
        ...
        let (__warp_se_24) = WS0_INDEX_Uint256_to_felt(MyNFT.__warp_0__ownerOf, __warp_14_id);
        
        let (__warp_15_owner) = WS1_READ_felt(__warp_se_24);
        
        let __warp_rc_2 = 0;
        
            
            let (__warp_tv_2, __warp_tv_3) = MyNFT.__warp_conditional_approve_095ea7b3_3(__warp_15_owner);
        ...
        let (__warp_se_25) = WS0_INDEX_Uint256_to_felt(MyNFT.__warp_2__approvals, __warp_14_id);
        
        WS_WRITE0(__warp_se_25, __warp_13_spender);
    ...
    alloc_locals;
        ...
        let (__warp_se_26) = WS0_INDEX_Uint256_to_felt(MyNFT.__warp_0__ownerOf, __warp_16_id);
        
        let (__warp_se_27) = WS1_READ_felt(__warp_se_26);
        
        let (__warp_se_28) = warp_neq(__warp_se_27, 0);
        
        with_attr error_message("token doesn't exist"){
            assert __warp_se_28 = 1;
        }
        
        let (__warp_se_29) = WS0_INDEX_Uint256_to_felt(MyNFT.__warp_2__approvals, __warp_16_id);
        
        let (__warp_se_30) = WS1_READ_felt(__warp_se_29);
    ...
    with warp_memory, keccak_ptr{
        ...
        MyNFT.transferFrom_23b872dd_internal(__warp_25_from, __warp_26_to, __warp_27_id);
    ...
    with warp_memory, keccak_ptr{
        ...
        MyNFT.transferFrom_23b872dd_internal(__warp_28_from, __warp_29_to, __warp_30_id);
    ...
    alloc_locals;
        ...
        let (__warp_se_68) = WS3_INDEX_felt_to_warp_id(MyNFT.__warp_3_isApprovedForAll, __warp_35__i0);
        
        let (__warp_se_69) = WS0_READ_warp_id(__warp_se_68);
        
        let (__warp_se_70) = WS2_INDEX_felt_to_felt(__warp_se_69, __warp_36__i1);
        
        let (__warp_se_71) = WS1_READ_felt(__warp_se_70);
    ...
    with warp_memory, keccak_ptr{
        ...
        MyNFT.transferFrom_23b872dd_internal(__warp_22_from, __warp_23_to, __warp_24_id);
