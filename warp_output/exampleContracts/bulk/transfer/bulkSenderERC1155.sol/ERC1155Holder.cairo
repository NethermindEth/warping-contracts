...
namespace ERC1155Holder{
    ...
    alloc_locals;
        ...
        if (__warp_se_2 != 0){
            ...
            let (__warp_pse_0) = s3_supportsInterface_01ffc9a7(__warp_0_interfaceId);
    ...
    func s3_supportsInterface_01ffc9a7(__warp_0_interfaceId : felt)-> (__warp_1 : felt){
    alloc_locals;
    ...
    alloc_locals;
        ...
        let __warp_rc_0 = 0;
            ...
            let (__warp_tv_0, __warp_tv_1) = ERC1155Holder.__warp_conditional_supportsInterface_01ffc9a7_1(__warp_0_interfaceId);
...
@contract_interface
namespace ERC1155Holder_warped_interface_1{
