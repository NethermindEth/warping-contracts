...
namespace ERC20{
    ...
    with warp_memory, keccak_ptr{
        ...
        let (__warp_se_1) = WS1_INDEX_felt_to_warp_id(ERC20.__warp_5_allowance, __warp_se_0);
    ...
    with warp_memory, keccak_ptr{
        ...
        let (__warp_se_5) = WS0_INDEX_felt_to_Uint256(ERC20.__warp_4_balanceOf, __warp_cs_0);
        
        let (__warp_se_6) = WS0_INDEX_felt_to_Uint256(ERC20.__warp_4_balanceOf, __warp_cs_0);
        ...
        WS_WRITE1(__warp_se_5, __warp_se_8);
            ...
            let (__warp_se_9) = WS0_INDEX_felt_to_Uint256(ERC20.__warp_4_balanceOf, __warp_cs_1);
            
            let (__warp_se_10) = WS0_INDEX_felt_to_Uint256(ERC20.__warp_4_balanceOf, __warp_cs_1);
    ...
    with warp_memory, keccak_ptr{
        ...
        let (__warp_se_14) = WS1_INDEX_felt_to_warp_id(ERC20.__warp_5_allowance, __warp_16_from);
        ...
        let (__warp_se_18) = warp_neq256(__warp_20_allowed, Uint256(low=340282366920938463463374607431768211455, high=340282366920938463463374607431768211455));
            ...
            if (__warp_se_18 != 0){
                ...
                let (__warp_se_19) = WS1_INDEX_felt_to_warp_id(ERC20.__warp_5_allowance, __warp_16_from);
        ...
        let (__warp_se_24) = WS0_INDEX_felt_to_Uint256(ERC20.__warp_4_balanceOf, __warp_cs_2);
        
        let (__warp_se_25) = WS0_INDEX_felt_to_Uint256(ERC20.__warp_4_balanceOf, __warp_cs_2);
        ...
        WS_WRITE1(__warp_se_24, __warp_se_27);
            ...
            let (__warp_se_28) = WS0_INDEX_felt_to_Uint256(ERC20.__warp_4_balanceOf, __warp_cs_3);
            
            let (__warp_se_29) = WS0_INDEX_felt_to_Uint256(ERC20.__warp_4_balanceOf, __warp_cs_3);
    ...
    alloc_locals;
        ...
        let (__warp_se_34) = WS2_READ_felt(ERC20.__warp_2_decimals);
    ...
    alloc_locals;
        ...
        let (__warp_se_35) = WS1_READ_Uint256(ERC20.__warp_3_totalSupply);
    ...
    alloc_locals;
        ...
        let (__warp_se_36) = WS0_INDEX_felt_to_Uint256(ERC20.__warp_4_balanceOf, __warp_29__i0);
    ...
    alloc_locals;
        ...
        let (__warp_se_38) = WS1_INDEX_felt_to_warp_id(ERC20.__warp_5_allowance, __warp_31__i0);
    ...
    with warp_memory{
        ...
        extern_input_check0(__warp_8__symbol_len, __warp_8__symbol);
        
        extern_input_check0(__warp_7__name_len, __warp_7__name);
        
        local __warp_8__symbol_dstruct : cd_dynarray_felt = cd_dynarray_felt(__warp_8__symbol_len, __warp_8__symbol);
        
        let (__warp_8__symbol_mem) = cd_to_memory0(__warp_8__symbol_dstruct);
        
        local __warp_7__name_dstruct : cd_dynarray_felt = cd_dynarray_felt(__warp_7__name_len, __warp_7__name);
        
        let (__warp_7__name_mem) = cd_to_memory0(__warp_7__name_dstruct);
