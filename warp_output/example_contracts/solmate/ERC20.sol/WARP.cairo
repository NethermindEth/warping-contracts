...
namespace WARP{
    ...
    alloc_locals;
        ...
        let (__warp_se_8) = WS0_INDEX_felt_to_Uint256(__warp_0__balances, __warp_16_sender);
        ...
        assert __warp_se_9 = 1;
            ...
            let (__warp_se_10) = WS0_INDEX_felt_to_Uint256(__warp_0__balances, __warp_16_sender);
        ...
        let (__warp_se_12) = WS0_INDEX_felt_to_Uint256(__warp_0__balances, __warp_cs_1);
        
        let (__warp_se_13) = WS0_INDEX_felt_to_Uint256(__warp_0__balances, __warp_cs_1);
    ...
    alloc_locals;
        ...
        let (__warp_se_1) = WS0_INDEX_felt_to_Uint256(WARP.__warp_0__balances, __warp_4_account);
    ...
    alloc_locals;
        ...
        let (__warp_se_3) = WS0_INDEX_felt_to_Uint256(WARP.__warp_0__balances, __warp_cs_0);
        
        let (__warp_se_4) = WS0_INDEX_felt_to_Uint256(WARP.__warp_0__balances, __warp_cs_0);
    ...
    alloc_locals;
        ...
        let (__warp_se_16) = WS0_INDEX_felt_to_Uint256(WARP.__warp_0__balances, __warp_23__i0);
