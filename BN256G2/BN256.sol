...
contract BN256G2 {
    ...
    ///warp-cairo
    /// func CURRENTFUNC(){range_check_ptr: felt}(x: Uint256, y: Uint256, p: Uint256) -> (remainder: Uint256) {
    ///
    ...
    /// }
    function expmod(uint256 a, uint256 b, uint256 p) internal pure returns (uint256 result) {
        return a+b+p;
    }
    function _modInv(uint256 a, uint256 n) internal pure returns (uint256 result) {
        return expmod(a,n-2,n);
    }
