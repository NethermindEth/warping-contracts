...
contract VaultAdmin is VaultStorage {
    ...
    modifier onlyGovernorOrStrategist() {
        require(
            msg.sender == strategistAddr || isOwner(),
    ...
    ****************************************/
     ...
     */
    function setRedeemFeeBps(uint256 _redeemFeeBps) external onlyOwner {
     ...
     */
    function setStrategistAddr(address _address) external onlyOwner {
     ...
     */
    function approveStrategy(address _addr) external onlyOwner {
    ...
    function removeStrategy(address _addr) external onlyOwner {
    ...
    function _depositToStrategy(
        ...
        for (uint256 i = 0; i < _assets.length; i++) {
            ...
            IERC20(_assets[i]).transfer(_strategyToAddress, _amounts[i]);
        }
     ...
     */
    function setTrusteeAddress(address _address) external onlyOwner {
     ...
     */
    function setTrusteeFeeBps(uint256 _basis) external onlyOwner {
