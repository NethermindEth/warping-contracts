 ...
 */
import "../lib/easySafeMath.sol";
import "../lib/easyOwnable.sol";
import "../utils/Initializable.sol";
import "../lib/easyERC20.sol";
// import "./utils/InitializableERC20Detailed.sol";
...
contract OUSD is Initializable, ERC20, Ownable {
    ...
    // ) external onlyOwner initializer ERC20(_nameArg, _symbolArg, 18) {
    ...
    function _isNonRebasingAccount(address _account) internal returns (bool) {
        if (rebaseState[_account] == RebaseOptions.NotSet) {
