...
namespace OUSD{
    ...
    func __warp_modifier_onlyOwner_transferOwnership_f2fde38b_15{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*, warp_memory : DictAccess*, keccak_ptr : felt*}(__warp_parameter___warp_3_newOwner14 : felt)-> (){
    alloc_locals;
        ...
        __warp_original_function_transferOwnership_f2fde38b_13(__warp_parameter___warp_3_newOwner14);
    ...
    func __warp_original_function_transferOwnership_f2fde38b_13{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*, warp_memory : DictAccess*, keccak_ptr : felt*}(__warp_3_newOwner : felt)-> (){
    alloc_locals;
    ...
    alloc_locals;
        ...
        let (__warp_5_oldOwner) = WS1_READ_felt(__warp_0__owner);
    ...
    alloc_locals;
        ...
        let (__warp_se_217) = get_caller_address();
    ...
    alloc_locals;
        ...
        let (__warp_pse_52) = mulTruncateScale_7473708e(__warp_4_x, __warp_5_y, Uint256(low=1000000000000000000, high=0));
    ...
    alloc_locals;
        ...
        let (__warp_pse_53) = div_a391c15b(__warp_11_z, __warp_9_scale);
    ...
    alloc_locals;
        ...
        let (__warp_pse_56) = div_a391c15b(__warp_20_z, __warp_18_y);
    ...
    alloc_locals;
        ...
        let (__warp_se_218) = warp_add256(__warp_22_a, __warp_23_b);
    ...
    alloc_locals;
        ...
        let (__warp_se_219) = warp_sub256(__warp_25_a, __warp_26_b);
    ...
    alloc_locals;
        ...
        let (__warp_se_220) = warp_mul256(__warp_28_a, __warp_29_b);
        
        
        
        return (__warp_se_220,);
    ...
    alloc_locals;
        ...
        let (__warp_se_221) = warp_div256(__warp_31_a, __warp_32_b);
        
        
        
        return (__warp_se_221,);
    ...
    alloc_locals;
        ...
        let (__warp_pse_48) = OUSD.owner_8da5cb5b_internal();
        
        let (__warp_se_212) = get_caller_address();
        
        let (__warp_se_213) = warp_eq(__warp_se_212, __warp_pse_48);
    ...
    with warp_memory, keccak_ptr{
        ...
        OUSD.__warp_modifier_onlyOwner_transferOwnership_f2fde38b_15(__warp_3_newOwner);
    ...
    alloc_locals;
        ...
        let (__warp_se_214) = ws_dynamic_array_to_calldata0(OUSD.__warp_4__name);
        
        
        
        return (__warp_se_214.len, __warp_se_214.ptr,);
    ...
    alloc_locals;
        ...
        let (__warp_se_215) = ws_dynamic_array_to_calldata0(OUSD.__warp_5__symbol);
        
        
        
        return (__warp_se_215.len, __warp_se_215.ptr,);
    ...
    alloc_locals;
        ...
        let (__warp_se_216) = WS1_READ_felt(OUSD.__warp_3__decimals);
    ...
    alloc_locals;
        ...
        let (__warp_pse_57) = OUSD.balanceOf_70a08231_internal(__warp_19__account);
    ...
    alloc_locals;
        ...
        let (__warp_pse_58) = OUSD.allowance_dd62ed3e_internal(__warp_43__owner, __warp_44__spender);
    ...
    alloc_locals;
        ...
        let (__warp_pse_59) = OUSD.owner_8da5cb5b_internal();
